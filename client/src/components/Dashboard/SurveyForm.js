      ...
      <form className="account-form" onSubmit={handleSubmit}>
        <div className="form-row form-row-3">
          ...
          <div className="form-group">
            ...
            <select id="genderIdentity" name="genderIdentity" value={form.genderIdentity} onChange={onChange}>
          ...
          <div className="form-group">
            ...
            <select id="ageGroup" name="ageGroup" value={form.ageGroup} onChange={onChange}>
        ...
        <div className="form-row">
          <div className="form-group" style={{ gridColumn: '1 / -1' }}>
            ...
            <select id="countryOfOrigin" name="countryOfOrigin" value={form.countryOfOrigin} onChange={onChange}>
              {COUNTRIES.map((c, idx) => (
