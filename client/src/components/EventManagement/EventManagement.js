...
export default function EventManagement() {
  ...
  const gridColumns = [
    ...
    { key: 'link', title: 'Event Link', render: (v) => v ? <a href={v} target="_blank" rel="noreferrer" className="ajf-btn ajf-btn-dark">Go to Event</a> : '-' },
        ...
        <main id="dashboard-main" className="dashboard-main" tabIndex={-1}>
          <div className="dashboard-content">
            ...
            {mode === 'list' ? (
              ...
              <form className="account-form" onSubmit={handleCreate} style={{ maxWidth: 720 }}>
                ...
                <div className="form-group">
                  <label className="form-label">Event Logo (upload to S3)</label>
